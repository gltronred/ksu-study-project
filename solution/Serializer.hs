...
ourHeader = Header 42 1001

solution = Solution ourHeader        [
...
solution2 = Solution ourHeader [Frame 0 3 [PVMapping 16000 1001.0, PVMapping 2 0.0, PVMapping 3 0.0], Frame 14000 0 []]